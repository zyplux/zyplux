...
3. allows widening a literal type
4. allows widening a literal initializer type
5. allows widening array element types
6. allows widening a class field literal type
7. allows erasing to unknown
...
5. allows an object literal that matches its annotation
