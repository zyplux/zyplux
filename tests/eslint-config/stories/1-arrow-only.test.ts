...
describe('1.1 banning ordinary function declarations and expressions', () => {
  const cases: ArrowCase[] = [
    ['1.1.1 bans function declarations', 'function foo() {}'],
    ['1.1.2 bans standalone function expressions', 'const f = function () {};'],
  ];

  test.for(cases)('%s', ([, code], { lint }) => {
...
describe('1.2 exempting generator functions, which have no arrow equivalent', () => {
  const cases: ArrowCase[] = [
    ['1.2.1 exempts generator function declarations', 'function* gen() { yield 1; }'],
    ['1.2.2 exempts generator function expressions', 'const stream = async function* () { yield 1; };'],
  ];
...
describe('1.3 exempting class and object methods, which have their own shorthand syntax', () => {
  const cases: ArrowCase[] = [
    ['1.3.1 exempts class methods', 'class Foo { method() {} }'],
    ['1.3.2 exempts object literal shorthand methods', 'const obj = { method() {} };'],
  ];
