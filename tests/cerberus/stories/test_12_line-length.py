...
def test_12_1_1_skips_repos_with_neither_a_ruff_nor_a_prettier_config(
    run_line_length: RunLineLength, finding: type[Finding], status: type[Status]
) -> None:
...
def test_12_2_1_fails_when_ruff_sets_a_different_line_length(
    run_line_length: RunLineLength, finding: type[Finding], status: type[Status]
) -> None:
...
def test_12_2_2_fails_when_ruff_does_not_set_a_line_length(
    run_line_length: RunLineLength, ruff: str, finding: type[Finding], status: type[Status]
) -> None:
