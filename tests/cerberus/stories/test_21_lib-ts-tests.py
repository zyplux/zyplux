...
_SEAM_LIB_PRIVATE_LEAKY = '{"name": "@demo/lib", "private": true, "exports": {".": "./src/index.ts", "./helpers": "./src/helpers.ts"}}'
...
_SEAM_FIXTURES_LIB_LEAKY = '{"name": "@demo/tests-fixtures", "exports": {".": "./src/index.ts", "./story": "./src/story.ts"}}'
_SEAM_TESTS_PKG = '{"name": "@demo/tests-lib", "private": true, "imports": {"#fixtures": "./fixtures.ts"}}'
_SEAM_TESTS_PKG_LEAKY_EXPORTS = (
    '{"name": "@demo/tests-lib", "private": true, "exports": {"./internal": "./internal.ts"}, "imports": {"#fixtures": "./fixtures.ts"}}'
)
...
_SEAM_LIB_IMPORT_STORY = "import {\n  helper,\n  otherHelper,\n} from '@demo/lib';\n\nimport { test } from '#fixtures';\n"
_SEAM_RELATIVE_ESCAPE_STORY = "import { internal } from '../../../packages/lib/src/internal.ts';\n\nimport { test } from '#fixtures';\n"
...
def test_21_1_1_skips_repos_with_no_typescript_packages(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({})
    assert result.findings == [finding(status.SKIP, "no TypeScript packages")]


def test_21_1_2_skips_workspaces_with_no_library(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
...
def test_21_1_4_leaves_a_private_test_package_unchecked(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
        "packages/lib/package.json": _SEAM_LIB,
        "packages/lib/src/index.ts": "",
...
def test_21_1_5_leaves_a_cli_app_to_the_cli_seam_check(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
        "apps/cli/package.json": _SEAM_CLI_LEAKY,
        "apps/cli/src/index.ts": "",
...
def test_21_1_6_covers_a_private_package_outside_tests_as_a_library(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
...
def test_21_2_1_passes_a_library_that_exports_only_the_root_seam(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
        "packages/lib/package.json": _SEAM_LIB,
        "packages/lib/src/index.ts": "",
...
def test_21_2_2_fails_a_library_that_declares_no_exports(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
...
def test_21_2_3_fails_and_names_each_export_beyond_the_root_seam(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
...
def test_21_2_4_fails_a_library_whose_exports_omit_the_root_entry(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
        "packages/lib/package.json": _SEAM_LIB_NO_ROOT,
        "packages/lib/src/index.ts": "",
    })
    assert result.findings == [finding(status.FAIL, "packages/lib/package.json: library exports must include the '.' root seam")]


def test_21_2_5_accepts_a_conditions_object_as_the_root_seam(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
...
def test_21_2_6_covers_a_published_library_under_the_tests_directory(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
...
def test_21_2_7_accepts_a_string_exports_as_the_root_seam(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
...
def test_21_3_2_fails_a_story_test_importing_the_library_directly(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
        "packages/lib/package.json": _SEAM_LIB,
        "packages/lib/src/index.ts": "",
...
def test_21_3_5_fails_a_story_test_importing_a_sibling_workspace_package(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
        "packages/lib/package.json": _SEAM_LIB,
        "packages/lib/src/index.ts": "",
...
def test_21_4_1_fails_an_imports_alias_that_escapes_the_test_package(run_lib_ts_tests: RunLibTsTests, finding: type[Finding], status: type[Status]) -> None:
    result = run_lib_ts_tests({
        "package.json": _SEAM_ROOT_WS,
        "packages/lib/package.json": _SEAM_LIB,
        "packages/lib/src/index.ts": "",
