...
def test_10_1_1_lint_validates_and_prints_path_valid(cli, tmp_path):
...
def test_10_1_2_lint_needs_no_root_and_changes_nothing(recipe, terminal, totchef, tmp_path):
...
def test_10_2_1_every_section_names_a_registered_cook_and_every_key_is_known(scenario, chef):
...
def test_10_2_2_dependencies_name_existing_nodes_with_no_cycles_or_self_dependencies(scenario, chef):
...
def test_10_2_3_needs_root_sits_on_a_leaf_entry_never_a_subtable_header(scenario, chef):
...
def test_10_2_4_remove_how_requires_remove_when(recipe, totchef):
...
def test_10_3_1_bin_commands_embed_a_version_or_offer_help(recipe, scenario, chef, totchef, bundled_files, tmp_path):
...
def test_10_3_2_conf_entries_declare_exactly_one_of_line_or_lines(recipe, scenario, chef, totchef, tmp_path):
...
def test_10_3_3_cook_entry_model_violations_are_reported_per_node_and_location(cli, tmp_path):
